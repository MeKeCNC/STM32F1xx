/*
  BTT_SKR_MINI_E3_V2.0_map.h - driver code for STM32F103RC ARM processors
...
//#define STEPPERS_DISABLE_PIN    14 //PB14
#define STEPPERS_X_DISABLE_PIN    14 //PB14
#define STEPPERS_Y_DISABLE_PIN    11 //PB11
#define STEPPERS_Z_DISABLE_PIN    1  //PB1
#define STEPPERS_X_DISABLE_BIT     (1<<STEPPERS_X_DISABLE_PIN)
#define STEPPERS_Y_DISABLE_BIT     (1<<STEPPERS_Y_DISABLE_PIN)
#define STEPPERS_Z_DISABLE_BIT     (1<<STEPPERS_Z_DISABLE_PIN)

#if N_AXIS > 3
#define STEPPERS_A_DISABLE_PIN     2  //PD2 //********
#define STEPPERS_A_DISABLE_BIT     (1<<STEPPERS_A_DISABLE_PIN)
#endif

#if N_AXIS == 4
#define STEPPERS_DISABLE_MASK      (STEPPERS_X_DISABLE_BIT|STEPPERS_Y_DISABLE_BIT|STEPPERS_Z_DISABLE_BIT|STEPPERS_A_DISABLE_BIT) // All direction bits
#else
#define STEPPERS_DISABLE_MASK      (STEPPERS_X_DISABLE_BIT|STEPPERS_Y_DISABLE_BIT|STEPPERS_Z_DISABLE_BIT) // All direction bits
#endif
//#define STEPPERS_OUTMODE   GPIO_MAP
